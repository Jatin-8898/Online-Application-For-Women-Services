<?php
    ...
    if(isset($_POST['register'])){
        ...
        if($obj->processLogin($email, $password)){
            ...
            Functions::redirect('index.php');          /*USED TO CALL STATIC ()*/
...
<head>
    <meta charset="utf-8"/>
    <title>Maharashta Gov Women Service | Register</title>
...
<div class="accountbg">
    <img src="assets/img/books.jpg" alt="" width="960" height="720">
</div>
                ...
                <div class="card-box p-5">
                    ...
                    <form class="" action="" method="POST">
                        ...
                        <div class="form-group text-center">
                            <a href="register.php">New User? Please Sign UP!!</a>
                        </div>
