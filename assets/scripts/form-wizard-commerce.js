var FormWizardCommerce = function () {
   return {
        ...
        init: function () {
            ...
            var displayConfirm = function() 
			{
				...
				sub_fee = document.getElementsByName("subject_fees[]");
				sub=document.getElementsByName("subject[]");
				subject_discount = document.getElementsByName("subject_discount[]");
				disc = document.getElementById("grand_discount");
				total = document.getElementById("total_fees").value;
				var count=0;
				...
				{	
					if (sub[i].checked==true) 
					{
						...
						row.appendChild(cell);
						var cell = document.createElement("td");    
						var cellText = document.createTextNode(""+sub_fee[i].value - subject_discount[i].value); 
						cell.appendChild(cellText);
						row.appendChild(cell);
						tblBody.appendChild(row);
					}
				}
				//adds the row of Discount
				var row = document.createElement("tr");
				var cell = document.createElement("td"); 
				...
				row.appendChild(cell);
				var cell = document.createElement("td"); 
				var cellText = document.createTextNode("Grand Discount Offered"); 
				cell.appendChild(cellText);
				row.appendChild(cell);
				var cell = document.createElement("td"); 
				var cellText = document.createTextNode(""+disc.value); 
				cell.appendChild(cellText);
				row.appendChild(cell);
				tblBody.appendChild(row);
				//end of row Discount
				
				//adds the row of total
				var row = document.createElement("tr");
				var cell = document.createElement("td"); 
				var cellText = document.createTextNode(""); 
				cell.appendChild(cellText);
